...
,mb_enable_match_commands_scroll( false ) 
{
    ...
    BaseCmd* pcmd = MEM_M_New dconsole::IO_Cmd1<MyString, MyString >("help", "Describes a command", Console::describe);
    registerCommand(pcmd);

    pcmd = MEM_M_New dconsole::CmdVar<bool>("echo", "print command line echo", set_echo, get_echo);
    registerCommand(pcmd);

    /*typedef void (Console::*MFP)(void);
    Gear::MemberTranslator<void,Console, MFP> fff = Gear::MakeFunctor((Gear::Functor<void>*)0, *this, &Console::onCmdLineChanged);
    cmd_line.setStrChangedCallback( fff );*/

	cmd_line.setStrChangedCallback(this);


    //m_pkbdevcontext = MEM_M_New KbdEventContext();

    // register events that will call console callback
/*
    // execute command
    Gear::FunctionTranslator<void, SimpleFP_t> on_return = Gear::MakeFunctor((Gear::Functor<void>*)0, Console::onKbdExecute);
    m_events.push_front( MEM_M_New ButtonPressedEvent(Gear::KeyboardInterface::Key_Return) );
    m_pkbdevcontext->AddEvent( *m_events.begin() , on_return);

    
    // match list
    Gear::FunctionTranslator1<void,  const KbdEventContext::FullEventInfo*, EventFP_t> on_up = Gear::MakeFunctor((Gear::Functor1<void, const KbdEventContext::FullEventInfo*>*)0, Console::onKbdPrev);
    m_events.push_front( MEM_M_New ButtonPressedRepeatedEvent(Gear::KeyboardInterface::Key_Up, m_repeat_interval) );
    m_pkbdevcontext->AddFullEvent( *m_events.begin() , on_up);

    Gear::FunctionTranslator1<void,  const KbdEventContext::FullEventInfo*, EventFP_t> on_down = Gear::MakeFunctor((Gear::Functor1<void, const KbdEventContext::FullEventInfo*>*)0, Console::onKbdNext);
    m_events.push_front( MEM_M_New ButtonPressedRepeatedEvent(Gear::KeyboardInterface::Key_Down, m_repeat_interval) );
    m_pkbdevcontext->AddFullEvent( *m_events.begin(), on_down);

    Gear::FunctionTranslator1<void,  const KbdEventContext::FullEventInfo*, EventFP_t> on_pgup = Gear::MakeFunctor((Gear::Functor1<void, const KbdEventContext::FullEventInfo*>*)0, Console::onKbdPrevPage);
    m_events.push_front( MEM_M_New ButtonPressedRepeatedEvent(Gear::KeyboardInterface::Key_Prior, m_repeat_interval) );
    m_pkbdevcontext->AddFullEvent( *m_events.begin(), on_pgup);

    Gear::FunctionTranslator1<void,  const KbdEventContext::FullEventInfo*, EventFP_t> on_pgdown = Gear::MakeFunctor((Gear::Functor1<void, const KbdEventContext::FullEventInfo*>*)0, Console::onKbdNextPage);
    m_events.push_front( MEM_M_New ButtonPressedRepeatedEvent(Gear::KeyboardInterface::Key_Next, m_repeat_interval) );
    m_pkbdevcontext->AddFullEvent( *m_events.begin(), on_pgdown);

    // cmd line
    Gear::FunctionTranslator<void, SimpleFP_t> on_autocomplete = Gear::MakeFunctor((Gear::Functor<void>*)0, Console::onKbdAutocomplete);
    m_events.push_front( MEM_M_New ButtonPressedWithModifierEvent(Gear::KeyboardInterface::Key_Space, Gear::KeyboardInterface::Key_LControl) );
    m_pkbdevcontext->AddEvent( *m_events.begin(), on_autocomplete);

    Gear::FunctionTranslator<void, SimpleFP_t> on_backspace = Gear::MakeFunctor((Gear::Functor<void>*)0, Console::onKbdBackspace);
    m_events.push_front( MEM_M_New ButtonPressedRepeatedEvent(Gear::KeyboardInterface::Key_Back, m_repeat_interval) );
    m_pkbdevcontext->AddEvent( *m_events.begin(), on_backspace);
    
    Gear::FunctionTranslator<void, SimpleFP_t> on_home = Gear::MakeFunctor((Gear::Functor<void>*)0, Console::onKbdMoveHome);
    m_events.push_front( MEM_M_New ButtonPressedEvent(Gear::KeyboardInterface::Key_Home) );
    m_pkbdevcontext->AddEvent( *m_events.begin(), on_home);

    Gear::FunctionTranslator<void, SimpleFP_t> on_end = Gear::MakeFunctor((Gear::Functor<void>*)0, Console::onKbdMoveEnd);
    m_events.push_front( MEM_M_New ButtonPressedEvent(Gear::KeyboardInterface::Key_End) );
    m_pkbdevcontext->AddEvent( *m_events.begin(), on_end);

    Gear::FunctionTranslator<void, SimpleFP_t> on_left = Gear::MakeFunctor((Gear::Functor<void>*)0, Console::onKbdMoveLeft);
    m_events.push_front( MEM_M_New ButtonPressedRepeatedEvent(Gear::KeyboardInterface::Key_Left, m_repeat_interval) );
    m_pkbdevcontext->AddEvent( *m_events.begin(), on_left);

    Gear::FunctionTranslator<void, SimpleFP_t> on_right = Gear::MakeFunctor((Gear::Functor<void>*)0, Console::onKbdMoveRight);
    m_events.push_front( MEM_M_New ButtonPressedRepeatedEvent(Gear::KeyboardInterface::Key_Right, m_repeat_interval) );
    m_pkbdevcontext->AddEvent( *m_events.begin(), on_right);

    Gear::FunctionTranslator<void, SimpleFP_t> on_delete = Gear::MakeFunctor((Gear::Functor<void>*)0, Console::onKbdDelete);
    m_events.push_front( MEM_M_New ButtonPressedRepeatedEvent(Gear::KeyboardInterface::Key_Delete, m_repeat_interval) );
    m_pkbdevcontext->AddEvent( *m_events.begin(), on_delete);

    Gear::FunctionTranslator1<void, const KbdEventContext::FullEventInfo*, EventFP_t> functor = Gear::MakeFunctor((Gear::Functor1<void, const KbdEventContext::FullEventInfo*>*)0, Console::onKbdEvent);
    m_events.push_front( MEM_M_New AnyButtonPressedEvent(true, m_repeat_interval) );
    m_pkbdevcontext->AddFullEvent( *m_events.begin(), functor);
*/
}

Console::~Console()
{
    /*std::list<KbdEvent*>::iterator it = m_events.begin();
...
//GraphicConsole& GraphicConsole::Instance(void)
//{                                                            
//    if (!ms_instance)
//        ms_instance = MEM_M_New GraphicConsole();
//    return *ms_instance;
//}
//
//void GraphicConsole::DestroyInstance()
//{
//    if (ms_instance)
//    {
//        MEM_M_Delete ms_instance;
//        ms_instance = NULL;
//    }
//}
